...
import { makeSelectCardBillList, makeSelectCardApiLoading } from "./selectors";
...
class CreditCardBillList extends React.Component {
  ...
  renderRow(bank,bank_name) {
    return (
      <View>
        <TouchableOpacity  style={[styles.sectionListRow]} button onPress={() => this.editCard(bank.id,bank_name)}>
